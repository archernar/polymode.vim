...
function! PolyMode(direction)
     ...
     if s:polyenabled == 0 
          ...
          nnoremap <silent> <PageUp>   :call EditInTempBuffer("~/.vimnotes")<cr>:normal zR<cr>:resize +15<cr>
     ...
     if s:polyenabled == 2 
          ...
          nnoremap <silent> <Insert> :call PolyMode(-2)<cr>
          nnoremap <silent> <PageUp>   <C-w>s:call PromptAndEdit():call PolyModeReset()<cr><C-W>w
