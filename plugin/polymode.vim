...
function! PolyModeZeroMappings()
           ...
           call g:MyKeyMapper("nnoremap <silent> h :call PolyModeResetQuiet()<cr>:KPOLY<cr>","Polymode Help")
           call g:MyKeyMapper("nnoremap <silent> hh :call PolyModeResetQuiet()<cr>:KSTD<cr>","Polymode Help")
