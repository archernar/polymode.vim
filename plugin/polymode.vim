...
function! PolyMode(direction)
     ...
     if s:polyenabled == 0 
          ...
          nnoremap <silent> <PageUp>   :call EditInTempBuffer("~/.vimnotes")<cr>:normal zi<cr>:resize +15<cr>
          nnoremap <silent> <PageDown> :call EditInTempBuffer("~/.vimnotes")<cr>:normal zi<cr>:resize +15<cr>
          return s:polyenabled 
     endif
     if s:polyenabled == 1 
